...
class MainOrdersDbAdapter implements DataDbAdapter, \Enlight_Hook
{
    ...
    private function getOrderColumns(): array
    {
        $columns = [
            ...
            'orders.net as orderNet',
            'orders.taxFree as orderTaxFree',
            'payment.description as paymentName',
            'orders.currency as orderCurrency',
            'orders.currencyFactor as orderCurrencyFactor',
            'orders.transactionId as orderTransactionId',
            'orders.trackingCode as orderTrackingCode',
