...
class TreeHelper
{
    ...
    public static function getDefaultTreeByProfileType(string $profileType): string
    {
        switch ($profileType) {
            ...
            case DataDbAdapter::PRODUCT_ADAPTER:
            ...
            case DataDbAdapter::PRODUCT_INSTOCK_ADAPTER:
            ...
            case DataDbAdapter::PRODUCT_PRICE_ADAPTER:
            ...
            case DataDbAdapter::PRODUCT_IMAGE_ADAPTER:
            ...
            case DataDbAdapter::PRODUCT_TRANSLATION_ADAPTER:
