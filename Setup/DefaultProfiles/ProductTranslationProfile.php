...
class ProductTranslationProfile implements \JsonSerializable, ProfileMetaData
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return DataDbAdapter::PRODUCT_TRANSLATION_ADAPTER;
    }
                    ...
                    1 => [
                            ...
                            'children' => [
                                    0 => [
                                            ...
                                            'parentKey' => '',
                                            'shopwareField' => '',
                                            'children' => $this->getProductTranslationFields(),
                                        ],
                                ],
                        ],
                ],
    ...
    private function getProductTranslationFields(): array
    {
        return [
            0 => [
                    'id' => '5429676d78b28',
