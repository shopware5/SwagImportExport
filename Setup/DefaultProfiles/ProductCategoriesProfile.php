...
class ProductCategoriesProfile implements \JsonSerializable, ProfileMetaData
{
    /**
     * {@inheritdoc}
     */
                ...
                0 => [
                    ...
                    'children' => [
                        0 => [
                            ...
                            'parentKey' => '',
                            'shopwareField' => '',
                            'children' => $this->getProductCategoriesFields(),
                            'attributes' => null,
                        ],
                    ],
                    'shopwareField' => '',
    ...
    private function getProductCategoriesFields(): array
    {
        return [
            0 => [
                'id' => '53e0d365881b7',
