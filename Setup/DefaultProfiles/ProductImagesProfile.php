...
class ProductImagesProfile implements \JsonSerializable, ProfileMetaData
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return DataDbAdapter::PRODUCT_IMAGE_ADAPTER;
    }
                ...
                1 => [
                    ...
                    'children' => [
                        0 => [
                            ...
                            'parentKey' => '',
                            'shopwareField' => '',
                            'children' => $this->getProductImagesFields(),
                        ],
                    ],
                ],
            ],
    ...
    private function getProductImagesFields(): array
    {
        return [
            0 => [
                'id' => '53ff1e618a9ad',
