...
class ProductSimilarsProfile implements \JsonSerializable, ProfileMetaData
{
    /**
     * {@inheritdoc}
     */
                ...
                0 => [
                    ...
                    'children' => [
                        0 => [
                            ...
                            'parentKey' => '',
                            'shopwareField' => '',
                            'children' => $this->getProductSimilarsFields(),
                            'attributes' => null,
                        ],
                    ],
                    'shopwareField' => '',
    ...
    private function getProductSimilarsFields(): array
    {
        return [
            0 => [
                'id' => '53e0d365881b7',
