...
class DbalHelperTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test_get_query_builder_for_entity_should_return_insert_query()
    {
        ...
        $builder = $this->SUT->getQueryBuilderForEntity($importData, 'Shopware\Models\Article\Article', self::CREATE_INSERT_STATEMENT);
