...
namespace Functional\Components\SwagImportExport\FileIO;
...
class XmlFileReaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test_article_translation_read()
    {
        ...
        $this->assertEquals(53, count($records));
     ...
     * @return int
     */
    private function getReaderCount($tree, $filename)
    {
     ...
     * @return array
     */
    private function getReaderRecords($tree, $filename, $startPosition = 0, $count = 50)
    {
        $reader = new XmlFileReader();
        $reader->setTree($tree);
     ...
     * @return array
     */
    private function getDefaultArticleTree()
    {
        return [
            'id' => 'root',
            'name' => 'Root',
     ...
     * @return array
     */
    private function getMinimalArticleTree()
    {
        return [
            'id' => 'root',
            'name' => 'Root',
     ...
     * @return array
     */
    private function getMinimalCategoryTree()
    {
        return [
            'id' => 'root',
            'name' => 'Root',
     ...
     * @return array
     */
    private function getMinimalCustomerTree()
    {
        return [
            'id' => 'root',
            'name' => 'Root',
     ...
     * @return array
     */
    private function getArticleTranslationTree()
    {
        return [
            'id' => 'root',
            'name' => 'Root',
     ...
     * @return array
     */
    private function getMinimalVariantsTree()
    {
        return [
            'id' => 'root',
            'name' => 'Root',
     ...
     * @return array
     */
    private function getOrdersTree()
    {
        return [
            'id' => 'root',
            'name' => 'Root',
     ...
     * @return array
     */
    private function getNewsletterRecipientsTree()
    {
        return [
            'id' => 'root',
            'name' => 'Root',
