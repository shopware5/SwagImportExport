...
class ProductsImagesDbAdapterTest extends TestCase
{
    ...
    private function getProductImagesDbAdapter(): ProductsImagesDbAdapter
    {
        return $this->getContainer()->get(ProductsImagesDbAdapter::class);
    }
