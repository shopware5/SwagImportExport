...
{
    public const PRODUCT_PROFILE_TYPE = DataDbAdapter::PRODUCT_ADAPTER;
    public const PRODUCT_PROFILE_NAME = 'article_profile';
    public const PRODUCT_TABLE = 's_articles';

    public const VARIANT_PROFILE_TYPE = DataDbAdapter::PRODUCT_ADAPTER;
    public const VARIANT_PROFILE_NAME = 'variant_profile';
    public const VARIANT_TABLE = 's_articles_details';

    public const CUSTOMER_PROFILE_TYPE = DataDbAdapter::CUSTOMER_ADAPTER;
    public const CUSTOMER_PROFILE_NAME = 'customer_profile';
    public const CUSTOMER_TABLE = 's_user';

    public const CATEGORY_PROFILE_TYPE = DataDbAdapter::CATEGORIES_ADAPTER;
    public const CATEGORY_PROFILE_NAME = 'category_profile';
    public const CATEGORY_TABLE = 's_categories';

    public const PRODUCTS_INSTOCK_PROFILE_TYPE = DataDbAdapter::PRODUCT_INSTOCK_ADAPTER;
    public const PRODUCTS_INSTOCK_PROFILE_NAME = 'article_instock_profile';

    public const PRODUCTS_PRICES_PROFILE_TYPE = DataDbAdapter::PRODUCT_PRICE_ADAPTER;
    public const PRODUCTS_PRICES_PROFILE_NAME = 'articles_price_profile';
    public const PRODUCTS_PRICES_TABLE = 's_articles_prices';

    public const PRODUCTS_IMAGES_PROFILE_TYPE = DataDbAdapter::PRODUCT_IMAGE_ADAPTER;
    public const PRODUCTS_IMAGE_PROFILE_NAME = 'articles_image_profile';

    public const PRODUCTS_TRANSLATIONS_PROFILE_TYPE = DataDbAdapter::PRODUCT_TRANSLATION_ADAPTER;
    public const PRODUCTS_TRANSLATIONS_PROFILE_NAME = 'articles_translations_profile';

    public const ORDERS_PROFILE_TYPE = DataDbAdapter::ORDER_ADAPTER;
    public const ORDERS_PROFILE_NAME = 'order_profile';
    public const ORDER_TABLE = 's_order';

    public const MAIN_ORDERS_PROFILE_TYPE = DataDbAdapter::MAIN_ORDER_ADAPTER;
    ...
    public const TRANSLATIONS_PROFILE_TYPE = DataDbAdapter::TRANSLATION_ADAPTER;
    public const TRANSLATIONS_PROFILE_NAME = 'translation_profile';

    public const NEWSLETTER_PROFILE_TYPE = DataDbAdapter::NEWSLETTER_RECIPIENTS_ADAPTER;
