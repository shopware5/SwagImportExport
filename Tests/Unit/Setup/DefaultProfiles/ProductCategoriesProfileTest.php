...
use SwagImportExport\Setup\DefaultProfiles\ProductCategoriesProfile;
...
class ProductCategoriesProfileTest extends TestCase
{
    ...
    {
        $categoryProfile = $this->createProductCategoriesProfile();

        static::assertInstanceOf(ProductCategoriesProfile::class, $categoryProfile);
    ...
    private function createProductCategoriesProfile(): ProductCategoriesProfile
    {
        return new ProductCategoriesProfile();
    }
}
