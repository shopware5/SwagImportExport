...
use SwagImportExport\Setup\DefaultProfiles\ProductImageUrlProfile;
...
class ProductImageUrlProfileTest extends TestCase
{
    ...
    private function createProductImageUrlProfile(): ProductImageUrlProfile
    {
        return new ProductImageUrlProfile();
    }
}
